package com.solr.base.spring.test;


import com.solr.base.spring.po.Product;
import com.solr.base.spring.service.ProductService;
...
public class ProductServiceTest {
    ...
    public void findByProductName() {
        ...
        int currentPage = 0;
        int pageSize = 10;
        Page<Product> page = productService.findByProductName(productName,currentPage,pageSize);
