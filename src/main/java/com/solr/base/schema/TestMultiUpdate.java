...
public class TestMultiUpdate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SchemaRequest.AddFieldType addFieldType = TestAddFieldType.createAddFieldType(fieldTypeName);
        SchemaRequest.AddField addField = TestAddField.createAddField(fieldName,fieldTypeName);
