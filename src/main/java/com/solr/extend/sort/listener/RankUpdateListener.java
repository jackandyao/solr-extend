package com.solr.extend.sort.listener;
import com.solr.extend.sort.index.IndexWeibo;
import com.solr.extend.sort.model.Weibo;
import com.solr.extend.util.GerneralUtils;
import com.solr.extend.util.jdbc.DBUtil;
